...
from app.scrap_mcp.tool.text import use_tra
from app.scrap_mcp.tool.bing import use_bing_n_page
from app.scrap_mcp.tool.goo_api import use_google

# FastAPI 환경에서는 stdout/stderr 설정 제거
